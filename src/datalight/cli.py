...
def ingest_directory(
    ...
    config: Optional[Path] = typer.Option(None, "--config", exists=True, dir_okay=False, help="DataLight config YAML"),
...
def pipeline_markdown_qa(
    ...
    expand_mode: str = typer.Option("detail", "--expand-mode", help="Expansion mode: detail, contextual, reasoning"),
